...
<div id="formset" hidden>
    @include('managements.inquirytypes.formset', [])
</div>

<div class="contents">
    <div class="subject">
        <span><i class="fas fa-fw fa-tools"></i> @lang('strings.inquiry_type')</span>
    </div>

    {{Form::open(['name' => 'form', 'url' => '/managements/inquiry/types/save', 'method' => 'post', 'files' => true])}}
    @csrf

    <div id="items">
    @foreach ($types as $index => $type)
        @include('managements.inquirytypes.formset', compact('type'))
    @endforeach
    </div>
