    ...
    <div class="grid-contents">
        <div class="w-50">
            ...
            <div>
                ...
                <div>
                    <div><label>{{Form::radio('anonymous_permission', '0', $settings['anonymous_permission'] == 0, []) }}&nbsp;@lang('strings.anonymous_permisshon_not_allowed')</label></div>
                    <div><label>{{Form::radio('anonymous_permission', '1', $settings['anonymous_permission'] == 1, []) }}&nbsp;@lang('strings.anonymous_permisshon_allowed')</label></div>
                </div>
        ...
        <div class="w-50">
            <div>
                ...
                <label for="login_image_radio{{$theme['id']}}">
                    <div style="margin: 6px; background: {{$theme['body_color']}}; border: 1px dotted {{$settings['border_color']}}">
