<!-- Topbar -->
<nav class="navbar navbar-expand navbar-light bg-gray topbar mb-3 static-top shadow p-0">

    <!-- Topbar Search -->
    <form class="d-none d-sm-inline-block form-inline navbar-search mr-auto ml-md-3">
        <div class="input-group">
            <input type="text" class="form-control bg-gray border-1 small" placeholder="サイト内検索"
                ...
                <a class="dropdown-item d-flex align-items-center" href="/messages/{{$receiveMessage->message_id}}">
                    <div class="dropdown-list-image mr-3">
                        <img class="rounded-circle"
                            src="/show/image?file={{$receiveMessage->image_file}}"
                            alt="...">
...
-->
                <a class="dropdown-item text-center small text-gray-500" href="/messages/inbox">@lang('strings.readmore')</a>
            </div>
        </li>
